...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CC Switch-KP)
...
After starting the proxy and enabling app takeover, CC Switch-KP modifies app configurations:
...
When stopping the proxy, CC Switch-KP will:
