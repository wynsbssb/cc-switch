...
## What is CC Switch-KP

CC Switch-KP is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
CC Switch-KP solves these problems through a unified interface.
...
CC Switch-KP is built with a modern technology stack:
