...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | CC Switch-KP storage, CLI configuration file formats |
...
- Applicable to CC Switch-KP v3.16.0+
