...
2. CC Switch-KP updates the configuration file
...
1. Right-click the CC Switch-KP icon in the system tray
...
When switching providers, CC Switch-KP modifies the following files:
