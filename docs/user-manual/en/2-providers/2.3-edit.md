...
CC Switch-KP provides rich icon customization features:
...
This ensures CC Switch-KP and CLI tool configurations stay in sync.
...
When adding a provider, CC Switch-KP automatically extracts endpoint URLs from the configuration.
