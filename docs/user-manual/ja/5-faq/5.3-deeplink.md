...
CC Switch-KP は `ccswitch://` ディープリンクプロトコルをサポートしており、リンクからワンクリックで設定をインポートできます。
...
CC Switch-KP はオンラインのディープリンク生成ツールを提供しています：
...
CC Switch-KP 公式のオンラインディープリンク生成ツールを使用するとより便利です。
...
1. システムが CC Switch-KP を開くかどうかを確認
2. 確認後、CC Switch-KP が起動
3. インポート確認ダイアログを表示
4. インポートを確認
...
CC Switch-KP のインストール時に `ccswitch://` プロトコルが自動登録されます。
...
インポート前に CC Switch-KP は以下を実行します：
