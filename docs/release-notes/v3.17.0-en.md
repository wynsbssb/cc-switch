...
- **[Codex Official Login Preservation](../guides/codex-official-auth-preservation-guide-en.md)**: understand how CC Switch-KP preserves your official ChatGPT login when you switch to a third-party provider. This release goes a step further — the official account itself can now route through the proxy too (see "Added" below).
...
| File                                     | Description                                      |
| ---------------------------------------- | ------------------------------------------------ |
| `CC-Switch-KP-v3.17.0-Windows.msi`          | **Recommended** - MSI installer with auto-update |
| `CC-Switch-KP-v3.17.0-Windows-Portable.zip` | Portable build, unzip and run                    |
...
| File                             | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| `CC-Switch-KP-v3.17.0-macOS.dmg`    | **Recommended** - DMG installer, drag to Applications |
| `CC-Switch-KP-v3.17.0-macOS.zip`    | Unzip and drag to Applications, Universal Binary      |
| `CC-Switch-KP-v3.17.0-macOS.tar.gz` | For Homebrew install and auto-update                  |
