...
CC Switch-KP v3.7.0 新增六大核心功能，新增超过 18,000 行代码。
...
- **Windows**：`CC-Switch-KP-v3.7.0-Windows.msi` 或 `-Portable.zip`
- **macOS**：`CC-Switch-KP-v3.7.0-macOS.tar.gz` 或 `.zip`
- **Linux**：`CC-Switch-KP-v3.7.0-Linux.AppImage` 或 `.deb`
