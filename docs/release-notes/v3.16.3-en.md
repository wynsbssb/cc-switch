# CC Switch-KP v3.16.3

> 🎉 **CC Switch-KP has passed 100,000 Stars!**
...
| File                                     | Description                                      |
| ---------------------------------------- | ------------------------------------------------ |
| `CC-Switch-KP-v3.16.3-Windows.msi`          | **Recommended** - MSI installer with auto-update |
| `CC-Switch-KP-v3.16.3-Windows-Portable.zip` | Portable build, unzip and run                    |

### macOS

| File                             | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| `CC-Switch-KP-v3.16.3-macOS.dmg`    | **Recommended** - DMG installer, drag to Applications |
| `CC-Switch-KP-v3.16.3-macOS.zip`    | Unzip and drag to Applications, Universal Binary      |
| `CC-Switch-KP-v3.16.3-macOS.tar.gz` | For Homebrew install and auto-update                  |
...
- `CC-Switch-KP-v3.16.3-Linux-x86_64.AppImage` / `.deb` / `.rpm`
- `CC-Switch-KP-v3.16.3-Linux-arm64.AppImage` / `.deb` / `.rpm`
