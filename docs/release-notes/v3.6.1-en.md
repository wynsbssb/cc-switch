...
- Download `CC-Switch-KP-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CC-Switch-KP-v3.6.1-Windows.msi`
- **Portable**: `CC-Switch-KP-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `CC-Switch-KP-v3.6.1-Linux.AppImage`
- **Debian**: `CC-Switch-KP-v3.6.1-Linux.deb`
...
- **Customizable Storage Location** - Customize CC Switch-KP's configuration storage directory
...
CC Switch-KP is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
