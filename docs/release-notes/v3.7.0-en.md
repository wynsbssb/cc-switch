...
CC Switch-KP v3.7.0 introduces six major features with over 18,000 lines of new code.
...
v3.7.0 represents a shift in CC Switch-KP's positioning:
...
- **Windows**: `CC-Switch-KP-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `CC-Switch-KP-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `CC-Switch-KP-v3.7.0-Linux.AppImage` or `.deb`
