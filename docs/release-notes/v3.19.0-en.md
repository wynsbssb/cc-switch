...
| File                                     | Description                                      |
| ---------------------------------------- | ------------------------------------------------ |
| `CC-Switch-KP-v3.19.0-Windows.msi`          | **Recommended** - MSI installer with auto-update |
| `CC-Switch-KP-v3.19.0-Windows-Portable.zip` | Portable build, unzip and run                    |
...
| File                             | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| `CC-Switch-KP-v3.19.0-macOS.dmg`    | **Recommended** - DMG installer, drag to Applications |
| `CC-Switch-KP-v3.19.0-macOS.zip`    | Unzip and drag to Applications, Universal Binary      |
| `CC-Switch-KP-v3.19.0-macOS.tar.gz` | For Homebrew install and auto-update                  |
...
- `CC-Switch-KP-v3.19.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
- `CC-Switch-KP-v3.19.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
