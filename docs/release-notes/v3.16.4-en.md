# CC Switch-KP v3.16.4

> 🎉 **CC Switch-KP is now in the global top 100 on GitHub by stars!**
...
| File                                     | Description                                      |
| ---------------------------------------- | ------------------------------------------------ |
| `CC-Switch-KP-v3.16.4-Windows.msi`          | **Recommended** - MSI installer with auto-update |
| `CC-Switch-KP-v3.16.4-Windows-Portable.zip` | Portable build, unzip and run                    |
...
| File                             | Description                                           |
| -------------------------------- | ----------------------------------------------------- |
| `CC-Switch-KP-v3.16.4-macOS.dmg`    | **Recommended** - DMG installer, drag to Applications |
| `CC-Switch-KP-v3.16.4-macOS.zip`    | Unzip and drag to Applications, Universal Binary      |
| `CC-Switch-KP-v3.16.4-macOS.tar.gz` | For Homebrew install and auto-update                  |
...
- `CC-Switch-KP-v3.16.4-Linux-x86_64.AppImage` / `.deb` / `.rpm`
- `CC-Switch-KP-v3.16.4-Linux-arm64.AppImage` / `.deb` / `.rpm`
