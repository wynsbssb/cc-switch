...
- Download `CC-Switch-KP-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `CC-Switch-KP-v3.6.0-Windows.msi`
- **Portable**: `CC-Switch-KP-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `CC-Switch-KP-v3.6.0-Linux.AppImage`
- **Debian**: `CC-Switch-KP-v3.6.0-Linux.deb`
